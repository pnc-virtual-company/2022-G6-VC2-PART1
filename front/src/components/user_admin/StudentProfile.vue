        ...
        <div class="contain-right">
            ...
            <div class="updae_password" v-if="onReset">
                ...
                <div class="previouse_password">
                    ...
                    <input type="password" name="" id="" placeholder="previous password !!" v-model="oldPassword" required >
                </div>
                <div class="new_password">
                    <strong>New Password</strong>
                    <input type="password" name="" id="" placeholder="new password !!" v-model="newPassword" required>
                </div>
                <div class="conform_password">
                    <strong>Confirm Password</strong>
                    <input type="password" name="" id="" placeholder="confirm password !!" v-model="confirmPassword" required>
                </div>
    ...
    methods:{
        ...
        resetPassword(){
            if (this.newPassword==this.confirmPassword){
                let id = JSON.parse(localStorage.getItem("studentid"));
                let password = {oldPassword:this.oldPassword, newPassword:this.newPassword}
                axios.patch('students/' + id,password).catch(
...
<style scoped>
    ...
    /*
        RESET PASSWORD
     */
     .previouse_password,.new_password,.conform_password,.button-group,.button_group{
        width: 80%;
        margin-top:10px;
     }
     .previouse_password input,.new_password input,.conform_password input {
        width: 100%;
        padding:10px;
        font-size: 1.1rem;
        margin-top: 5px;
